...
function insert(what)
{
   ...
   case "image":
      ...
      break;
   case "gallery":
      strPage = "dlg_gallery.php";
      strAttr = "status:no;dialogWidth:800px;dialogHeight:600px;help:no";' '
      break;
   case "upload":
      strPage = "dlg_upload.php";
      strAttr = "status:no;dialogWidth:400px;dialogHeight:545px;help:no";' '
      break;
...
function link(on)
{
   ...
   if (strURL) {
      ...
      r.pasteHTML('<A href=' + strURL + ' target=_self>' + strText + '</a>');
   }
...
// handler of this control (see richedit.php)
